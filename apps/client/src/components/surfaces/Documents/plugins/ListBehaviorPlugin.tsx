...
/**
 * Plugin that handles list keyboard behavior:
 * - Enter on an empty list item exits the list (or outdents from a nested list).
 * - Tab / Shift+Tab indents / outdents the current list item, creating
 *   nested sublists as needed.
 */
